...
const FeeStructure = () => {
  ...
  const finalSubmit = () => {
    ...
    try {
      axios
        .post(
          `http://localhost:8000/api/fee-structure`,
          data
        )
        .then((res) => {
          console.log(res);
  ...
  const updateFeeStructure = () => {
    ...
    try {
      axios
        .put(
          `http://localhost:8000/api/fee-structure/${feeId}`,
          data
        )
        .then((res) => {
          console.log(res);
  ...
  const getFeeStructure = () => {
    try {
      axios
        .get(
          `http://localhost:8000/api/fee-structure/filter?className=${selectedClass}&category=${selectedCategory}&route=${selectedRoute}`
        )
        .then((res) => {
          console.log(res);
          if (res.data.success) {
