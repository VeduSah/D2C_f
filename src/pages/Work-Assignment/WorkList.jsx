...
const WorkList = () => {
  ...
  const fetchAssignments = async () => {
    ...
    try {
      ...
      if (role === "Teacher") {
        url = `http://localhost:5000/api/coordinator-assignment/teacher?teacherId=${userId}`;
      } else if (
        role === "Senior Coordinator" ||
        role === "Junior Coordinator"
      ) {
        url = `http://localhost:5000/api/coordinator-assignment/all?coordinatorId=${userId}`;
      } else {
        url = "http://localhost:5000/api/coordinator-assignment/all";
      }
